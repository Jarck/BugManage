        ...
        <div class="Right">
            ...
            <div class="relative CenterBox Sub">
                ...
                <s:form action="bugSearch" method="post">        	
                    ...
                    <span class="icon_bigest  left">
                         <label>关键字</label>
                        <input type="text" name="bugSearchInfo.bugName" class="SearchSelect"/>
                    </span>
            ...
            <div class="Solution">
                ...
                <div class="PageTop">
                    <a class="Blue" href="bugList.action">刷新</a>
                </div>
                <table border="0" width="100%" cellpadding="10" cellspacing="0" class="Bug box">
                    <tbody><tr class="BlueBackground Black BugTitle TableTop">
                        ...
                        <td width="10%"><a title="按照优先级正序排列" href=""><b>优先级</b><img src="./image/grayarrow.gif"/></a></td>
                        <td width="10%"><a title="按照状态正序排列" href=""><b>状态</b><img src="./image/grayarrow.gif"/></a></td>
                        <td width="10%"><a title="按照模块正序排列" href=""><b>处理人</b><img src="./image/grayarrow.gif"/></a></td>
                        <td width="10%"><a title="按照日期正序排列" href=""><b> 日期</b><img src="./image/grayarrow.gif"/></a></td>
                    </tr>
